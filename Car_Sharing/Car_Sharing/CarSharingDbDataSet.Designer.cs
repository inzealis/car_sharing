...
namespace Car_Sharing {
    ...
    public partial class CarSharingDbDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CarsRow AddCarsRow(string brand, string type, decimal rental_price) {
        ...
        public partial class CarsRow : global::System.Data.DataRow {
            ...
            public decimal rental_price {
                get {
                    return ((decimal)(this[this.tableCars.rental_priceColumn]));
                }
                set {
...
namespace Car_Sharing.CarSharingDbDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([Id] = @Original_Id) AND ([brand] = @Original_br" +
                "and) AND ([type] = @Original_type) AND ([rental_price] = @Original_rental_price)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([brand], [type], [rental_price]) VALUES (@brand, @type," +
                " @rental_price);\r\nSELECT Id, brand, type, rental_price FROM Cars WHERE (Id = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [brand] = @brand, [type] = @type, [rental_price] = @rental_price WHERE (([Id] = @Original_Id) AND ([brand] = @Original_brand) AND ([type] = @Original_type) AND ([rental_price] = @Original_rental_price));
SELECT Id, brand, type, rental_price FROM Cars WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Car_Sharing.Properties.Settings.Default.CarSharingDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, brand, type, rental_price FROM dbo.Cars";
        ...
        public virtual int Fill(CarSharingDbDataSet.CarsDataTable dataTable) {
        ...
        public virtual CarSharingDbDataSet.CarsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarSharingDbDataSet.CarsDataTable dataTable = new CarSharingDbDataSet.CarsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarSharingDbDataSet.CarsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_brand, string Original_type, decimal Original_rental_price) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((decimal)(Original_rental_price));
        ...
        public virtual int Insert(string brand, string type, decimal rental_price) {
            if ((brand == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(rental_price));
        ...
        public virtual int Update(string brand, string type, decimal rental_price, int Original_Id, string Original_brand, string Original_type, decimal Original_rental_price, int Id) {
            if ((brand == null)) {
                throw new global::System.ArgumentNullException("brand");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(rental_price));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_rental_price));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string brand, string type, decimal rental_price, int Original_Id, string Original_brand, string Original_type, decimal Original_rental_price) {
            return this.Update(brand, type, rental_price, Original_Id, Original_brand, Original_type, Original_rental_price, Original_Id);
        }
    }
